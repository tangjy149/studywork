...
$(".zhang").change(function(){
    ...
    */
    ...
    function cha(){
        ...
        $.ajax({
                type:'get',
                url:'http://localhost:8080/ques/teacher/getQuesByUserId',
    ...
    function chaBufen(){
        ...
        $.ajax({
                type:'get',
                url:'http://localhost:8080/ques/teacher/getQuesByUserIdAndSubordinate',
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
                data: {
                    chapterId:zhang,
                    sessionId:jie
    ...
    function zhangAjax(){
        $.ajax({
            type: 'get',
            async: false,
            url: 'http://localhost:8080/ques/getChapter',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: '',
            dataType: "json",
            success: function (rs) {
    ...
    function jieAjax(){
        ...
        $.ajax({
            type: 'get',
            url: 'http://localhost:8080/ques/getSession',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
    ...
    */
    ...
    function del(){  
        ...
        $.ajax({
            type: 'get',
            url: 'http://localhost:8080/ques/teacher/deleteQues',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: data,
            dataType: "json",
            success: function (rs) {
    ...
    */
    $(document).on('click','.J_close,.J_open',function(e){
        ...
        var trDel = $(e.target),
            ...
            $.ajax({
                type: 'get',
                url: 'http://localhost:8080/ques/teacher/changeStatus',
                data: data,
                dataType: "json",
                success: function (rs) {
                       alert("题目状态修改成功")
