...
function cha1(){
        ...
        $.ajax({
                type:'get',
                url:'http://localhost:8080/answer/teacher/getRecordSummary',
...
// 详情页
    ...
    function cha2(){
        ...
        $.ajax({
                type:'get',
                url:'http://localhost:8080/answer/teacher/getAnswerRecord',
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
                data:data,  
                dataType: "json",
                success: function (rs) {
...
// 题目详情页
    ...
    function cha3(){
        ...
        $.ajax({
            type: 'get',
            url:'http://localhost:8080/ques/teacher/getQuesByQuesIdAndType',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: data,  
            dataType: "json",
            success: function (rs) {
